        ...
        <div className="flex-1">
          ...
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              <h4 className="font-semibold text-gray-900 text-lg">{review?.user?.name || "مستخدم مجهول"}</h4>
              {isOwner && (
          ...
          {/* Review text */}
          {review?.review && (
            <div className="bg-gray-50 rounded-xl p-4 mb-4 border-l-4 border-blue-200">
              <p className="text-gray-800 leading-relaxed text-sm whitespace-pre-wrap">{review.review}</p>
            </div>
          )}
        </div>
      </div>
