...
export default function Fav() {
  ...
  if (!products?.length) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50/30 flex items-center justify-center">
        <div className="relative max-w-2xl mx-auto px-6">
          {/* Animated background elements */}
          <div className="absolute -top-20 -left-20 w-40 h-40 bg-gradient-to-r from-pink-400/20 to-purple-400/20 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute -bottom-20 -right-20 w-60 h-60 bg-gradient-to-r from-purple-400/20 to-blue-400/20 rounded-full blur-3xl animate-pulse delay-1000"></div>

          <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-12 text-center shadow-2xl border border-white/20">
            <div className="relative mb-8">
              ...
              <div className="relative w-32 h-32 mx-auto bg-gradient-to-r from-pink-100 to-purple-100 rounded-full flex items-center justify-center">
                <Empty className="text-gray-300 w-16 h-16" />
                <Heart className="absolute -top-2 -right-2 w-8 h-8 text-pink-500 animate-pulse" />
              </div>
            </div>

            <h3 className="text-3xl font-bold text-gray-800 mb-4 bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent">
              No Favorites Yet
            </h3>
            ...
            <div className="space-y-4">
              <a
                href="/shop"
                className="inline-flex items-center gap-3 bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-white px-8 py-4 rounded-2xl font-semibold text-lg transform hover:scale-105 transition-all duration-200 shadow-xl hover:shadow-2xl"
              >
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50/30">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="relative mb-12">
          <div className="absolute inset-0 bg-gradient-to-r from-pink-600/10 via-purple-600/10 to-blue-600/10 rounded-3xl blur-3xl"></div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-10 pr-4 py-3 bg-white/60 backdrop-blur-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all w-full sm:w-64"
                  />
                </div>
                ...
                <div className="flex gap-2">
                  <select
                    ...
                    className="px-4 py-3 bg-white/60 backdrop-blur-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all"
                  >
                  ...
                  <button
                    ...
                    className="p-3 bg-white/60 backdrop-blur-sm border border-gray-200 rounded-xl hover:bg-white/80 transition-all"
                  >
        ...
        >
          {filteredProducts?.map((product, index) => (
            ...
            >
              <div className="absolute -top-2 -right-2 z-10 bg-gradient-to-r from-pink-500 to-red-500 rounded-full p-2 shadow-lg transform group-hover:scale-110 transition-transform duration-200">
