    ...
    <div className="flex flex-col lg:flex-row gap-6 md:gap-8">
      ...
      <div className="lg:w-1/2 space-y-4 md:space-y-6">
        <div className="space-y-3 md:space-y-4">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 leading-tight">{vet?.vetName}</h1>
          ...
          <div className="space-y-2 md:space-y-3">
            <div className="flex items-center gap-3 p-3 md:p-4 bg-gray-50 rounded-lg md:rounded-xl border hover:shadow-md transition-shadow duration-300">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-900 font-semibold text-sm md:text-base">{vet?.locations.address}</p>
              </div>
            </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-3 md:pt-4">
          <Button
            ...
            asChild
          >
            <a href={`tel:${vet?.callNumber}`} className="flex items-center justify-center gap-2 md:gap-3">
    ...
    <div className="flex flex-col xs:flex-row items-start xs:items-center gap-3">
      <div className="flex items-center gap-3 w-full xs:w-auto">
        ...
        <div className="flex-1 xs:flex-none">
          <p className="font-semibold text-gray-900 text-sm sm:text-base line-clamp-1">{vet?.vetName}</p>
